...
#We will calculate it by checking how many values have a difference to their ground truth equivalent less than given precision
#we will calculate this precision as a fraction of standard deviation of all the ground truth values
...
for epoch in range(10001):
	...
	dense1.forward(X)
	#forward pass thru activation function, takes output of 1st dense layer
	activation1.forward(dense1.output)
	#perform 4ward pass thru Dropout layer
	#dropout1.forward(activation1.output)
	#forward pass thru 2nd dense layer, takes output of activation function of 1st layer as inputs
	dense2.forward(activation1.output)
	#forward pass thru activation function, takes output of 2nd dense layer
...
#calculate accuracy : absolute difference btwn predictions and ground truth values and compare if differences are lower than given precision value 
...
#Draw testing data and output data
